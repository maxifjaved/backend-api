...
const envVarsSchema = Joi.object({
	...
	APP_NAME: Joi.string().default('Muhammad Asif Javed <axif.javed@gmail.com> - Backend Api Starter Kit'),
	...
	EMAIL_HOST: Joi.string().required().description('Email host is required to send emails.'),
	EMAIL_PORT: Joi.string().required().description('Email post is required to setup email service.'),
	EMAIL_USER: Joi.string().required().description('Email address is required to send emails.'),
	EMAIL_PASS: Joi.string().required().description('Email password is required to send emails.'),
	EMAIL_SECURE: Joi.string().required().description('is email service using is secure?'),
	...
	COOKIE_SECRET: Joi.string().required().description('Cookie Secret required to sign'),
	EMAIL_CONFIRMATION_SECRET: Joi.string().required().description('Email Confirmation Secret required to sign'),
	RESET_PASSWORD_SECRET: Joi.string().required().description('Rest Password Secret required to sign'),
